...
const EditTenants = ({ user, onClose, setSeverity, setAlert, settings }) => {
  ...
  const [fileName, setFileName] = useState(user.image || null);
  const [imgSrc, setImgSrc] = useState(
    user.image ? CONFIG.API_URL + "/users/" + user.image : ""
  );
            ...
            if (file != null) {
              ...
              axios
                ...
                .then((res) => {
                  ...
                  axios
                    .patch(
                      CONFIG.API_URL + "/api/users/edit/" + user.id,
                      updateTenant,
                      {
                        headers: {
